...
#      3、定义测试报告
    ...
    smtp.login("117902974@qq.com", "sggzjbumebfnbaga")
...
if __name__ == '__main__':
    ...
    # 测试test_case的文件    此文件下的都会执行，包括子级文件夹
    test_dir_login = r'D:\code\python\zhihuishangmao\test_case'


    # 指定测试报告目录
    test_report_login = r'D:\code\python\zhihuishangmao\reports'
